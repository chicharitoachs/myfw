...
xtForm.provider('xtFormConfig', function () {
    ...
    var self = this,
        _errors = {
            minlength: 'Bắt buộc nhập ít nhất {{ngMinlength}} ký tự',
            maxlength: 'Bắt buộc nhập nhỏ hơn {{ngMaxlength}} ký tự',
            required: 'Trường này bắt buộc nhập',
            number: 'Bắt buộc nhập ký tự số',
            min: 'Bắt buộc nhập lớn hơn hoặc bằng {{min}}',
            max: 'Bắt buộc nhập nhỏ hơn hoặc bằng {{max}}',
            email: 'Must be a valid E-mail address',
            pattern: 'Giá trị không hợp lệ',
            url: 'Must be a valid URL',
            date: 'Bắt buộc nhập kiểu ngày',
            datetimelocal: 'Bắt buộc nhập kiểu ngày',
            time: 'Bắt buộc nhập kiểu thời gian',
            week: 'Bắt buộc nhập tuần hợp lệ',
            month: 'Bắt buộc nhập tháng hợp lệ',
