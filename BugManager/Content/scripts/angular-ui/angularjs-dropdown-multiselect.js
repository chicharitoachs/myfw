...
//                        itemsText.push('('+$scope.selectedModel.length+')');
//                    }
//                    debugger 
                    ...
                    var addStr = '(' + $scope.selectedModel.length + ') ';
                    if (widthLimit <= textWidth('(' + $scope.selectedModel.length + ')')) {
                        return addStr;
                    }
              
                    var testEst = addStr + result;
                ...
                for (var i = 0; i < $scope.selectedModel.length; i++) {
                    resultString.push($scope.selectedModel[i].label);
                }
                var text = resultString.join();
                if (totalSelected === 0) {
